...
let CXLOrderRefundElement = class CXLOrderRefundElement extends ViewElement {
    constructor() {
        super(...arguments);
...
__decorate(
    ...
    CXLOrderRefundElement.prototype,
    "amountFields",
    void 0
);
CXLOrderRefundElement = __decorate(
    [customElement("cxl-order-refund")],
    CXLOrderRefundElement
);
export { CXLOrderRefundElement };
